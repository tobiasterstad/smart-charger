...
from smart_charger.tibber.tibber_util import PriceInfo, PriceData, CurrentSubscription, Home, Viewer, Data, Prices
...
class TestTibberAdapter(unittest.TestCase):
    ...
    def test_tibber_adapter_uses_tomorrow_prices(self):
        ...
        prices = get_tibber_prices(today_pairs=missing_today, tomorrow_pairs=tomorrow_pair)
