...
class TestPlanner(unittest.TestCase):
    def test_planner_initialization(self):
        ...
        self.assertEqual(12.0, plan.energy_kwh)  # 80% target - 50% current = 30% of 40 kWh capacity
    ...
    def test_planned_energy_calculation_soc_23(self):
        ...
        self.assertEqual(23, plan.energy_kwh)  # 80% target - 23% current = 57% of 40 kWh capacity
    ...
    def test_energy_calculation(self):
        ...
        self.assertAlmostEqual(3.68, energy, places=2)  # 16A * 230V * 1h / 1000 = 3.68 kWh
